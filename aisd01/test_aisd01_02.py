import pytest
from aisd01_02 import LinkedList2, Node
...
def test_add_in_head(my_list):
    head = my_list.head
    my_list.add_in_head(Node(13))

    assert my_list.head.value == 13
    assert my_list.head.next == head
